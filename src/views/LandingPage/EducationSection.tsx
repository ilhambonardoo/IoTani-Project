        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {chiliVarieties.map((name, idx) => (
            <motion.article
              ...
              className="group relative overflow-hidden rounded-2xl border border-cyan-400/20 bg-white p-4 shadow-[0_0_0_1px_rgba(0,240,255,0.08)] ring-1 ring-white/5 backdrop-blur supports-[backdrop-filter]:bg-[#0E1218]/60"
            >
              {/* Image placeholder */}
              <div className="relative mb-4 aspect-[4/3] w-full overflow-hidden rounded-xl bg-white ring-1 ring-white/10">
