...
import { LuCamera, LuLock, LuSave } from "react-icons/lu";
...
const UserProfile = () => {
	...
	const onFile = async (e: React.ChangeEvent<HTMLInputElement>) => {
		...
		setUploading(true);
		try {
			// In a real app, replace with actual authenticated user ID
			...
			<div className="mx-auto w-full max-w-3xl rounded-3xl border border-cyan-400/20 bg-white/5 p-8 shadow-[0_0_0_1px_rgba(0,240,255,0.08)] ring-1 ring-white/5">
				<div className="flex flex-col items-center">
					<div className="relative">
						<div
							className="group relative h-32 w-32 overflow-hidden rounded-full ring-2 ring-cyan-400/40"
							onClick={onPick}
						>
							{avatar ? (
								<Image
